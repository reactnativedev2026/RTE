...
interface MemberBestDaysProps {
  loading?: boolean;
  data?: object | undefined | any;
  containerStyle?: ViewStyle;
}

const MemberBestDays = ({containerStyle}: MemberBestDaysProps) => {
  ...
  return (
    <View style={[styles.container, containerStyle]}>
      <View style={styles.header}>
        <Text style={styles.headerText}>Members' Best Days</Text>
